...
// eeyes_header += '    <li><a href="http://2.eeyes.net/" target="_blank">二手市场</a></li>';
...
eeyes_header += '    <li><a href="http://piao.eeyes.net/" target="_blank">大屏幕</a></li>';
...
eeyes_footer += '<style>#eeyes_footer {margin:0;padding:0;z-index:9999;width:100%;background:url("http://www.eeyes.net/public/bg_white60.png");bottom: 0;border-top:4px #ccc solid;padding:10px 0;text-align:center;font-size:12px;font-family:Helvetica,Arial,"Hiragino Sans GB","Microsoft Yahei","WenQuanYi Micro Hei",sans-serif; color:#333;}</style>';
